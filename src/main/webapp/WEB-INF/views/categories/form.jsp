...
<head>
    ...
    <title>${category.id == null ? 'Add' : 'Edit'} Category - Retail Purchase Management</title>
...
<div class="page-header">
    <div class="container">
        <h1>${category.id == null ? 'Add New' : 'Edit'} Category</h1>
        <p>${category.id == null ? 'Create a new category' : 'Update category information'}</p>
    </div>
</div>
<div class="container">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-body">
                    <form:form action="<c:url value='/categories/save'/>" method="post" modelAttribute="category">
                        <form:hidden path="id" />
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="<c:url value='/categories'/>" class="btn btn-secondary me-md-2">
